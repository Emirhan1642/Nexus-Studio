...
void NexusTheme::apply() {
    ...
    s.Colors[ImGuiCol_FrameBgHovered]=HexColor(0x242424);
    ...
    s.Colors[ImGuiCol_Header]       = HexColorAlpha(0x00d2ff, 0.15f);
    s.Colors[ImGuiCol_HeaderHovered]= HexColorAlpha(0x00d2ff, 0.25f);
    ...
    s.Colors[ImGuiCol_TabUnfocused] = HexColor(0x0e0e0e);
    s.Colors[ImGuiCol_TabUnfocusedActive]= HexColor(0x050505);
