...
void ExplorerPanel::draw() {
    ...
    dl->AddLine(ImVec2(winP.x + w - 1.0f, winP.y), ImVec2(winP.x + w - 1.0f, winP.y + winH), COL(T.border));
    dl->AddLine(ImVec2(winP.x, winP.y + winH - 1.0f), ImVec2(winP.x + w, winP.y + winH - 1.0f), COL(T.border));
